...
export const Route = createFileRoute("/register")({
  ...
  head: () => ({
    meta: [
      { title: "Register — C-ROB Smart Key Locker" },
      {
        name: "description",
        content: "Create your account to access the C-ROB lab key.",
      },
    ],
  }),
...
function RegisterPage() {
  ...
  async function onGoogleSignIn() {
    setError(null);
    if (!supabase) {
      setError("Registration is not available until the Supabase project is connected.");
      return;
    }
    setBusy(true);
  ...
  return (
    <AuthLayout
      ...
      subtitle="Join the C-ROB Smart Key Locker system."
      footer={
        <>
